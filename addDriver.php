...
if(isset($_POST['submit']))
{
	...
	$error = 0
		...
		// db insert
		try{
		$stmt = $db->prepare('INSERT INTO driver (StaffID,Name,Age,LicenseID) VALUES (:staffID,:name,:age,:licenseID)');
		$stmt->execute(array('staffID' => $_POST['staffID'],   'name' => $_POST['name'], 'age' => $_POST['age'], 'licenseID' => $_POST['licenseID'] ));
